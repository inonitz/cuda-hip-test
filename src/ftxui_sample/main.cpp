...
// configuration step. It creates a namespace called `cuda_hip_test`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cuda_hip_test::cmake::project_name, cuda_hip_test::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cuda_hip_test::cmake::project_version);
      return EXIT_SUCCESS;
    }
